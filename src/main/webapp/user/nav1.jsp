...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li class="${param.ctclass}"><a href="create-task.html"><i class="fa fa-edit"></i> 编写绩效</a></li>
            <li class="${param.neclass}"><a href="/user/somenews.do"><i class="fa fa-font"></i> 公告</a></li>
            <li class="${param.cnclass}"><a href="create-news.jsp"><i class="fa fa-edit"></i> 编写公告</a></li>
